...
void main() async {
  SystemChrome.setSystemUIOverlayStyle(SystemUiOverlayStyle(
      statusBarColor: Color.fromRGBO(79, 178, 145, 1.0),
...
class _HomePageState extends State<HomePage> {
  ...
  final List<String> webviewList = [
    "https://demo.membirds.com/",
    "https://demo.membirds.com/products/voorbeeld-product-1"
  ];
  ...
  Widget build(BuildContext context) {
    int x = 0;
    String url = "https://demo.membirds.com/";
    ...
    return MaterialApp(
        ...
        home: Scaffold(
          bottomNavigationBar: BottomNavigationBar(
            ...
            selectedItemColor: Color.fromRGBO(79, 178, 145, 1.0),
            onTap: (i) {
              ...
              child: hideui
                ...
                child: WebView(
                  ...
                  navigationDelegate: (NavigationRequest request) async {
                    ...
                    if (request.url.contains(pubble)) {
                      String pubbleurl = request.url;
